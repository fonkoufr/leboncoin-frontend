    ...
    const initAutocomplete = () => {
        ...
        autoCompleteRef.current.addListener("place_changed", () => {
            ...
            if (place && place.formatted_address) {
                ...
                // 2. Notification au parent (CORRECTION : on n'utilise plus lat/lng inutilisés ici)
                if (onLocationSelect) {
  ...
  return (
    <div style={styles.formContainer}>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        <div style={styles.formRow}>
          ...
          <div style={{...styles.formGroup, flex:1}}>
            ...
            <CityAutocomplete 
                ...
                onLocationSelect={(cityName) => {
                    // UTILISATION DE L'API EMBED POUR LA CARTE (Plus simple, pas besoin de lat/lng)
        ...
        {/* APERÇU DE LA CARTE GOOGLE MAPS */}
        {mapUrl && (
...
const styles = {
  ...
  navInner: { maxWidth: 1280, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 20 },
  navLeft: {},
  logo: { fontSize: 22, fontWeight: 800, cursor: "pointer", letterSpacing: -1, color: "#1a1a1a" },
  logoAccent: { color: "#E8553A" },
  searchBar: { flex: 1, maxWidth: 420, display: "flex", alignItems: "center", gap: 8, background: "#f5f5f3", borderRadius: 10, padding: "8px 14px", border: "1px solid #eee" },
  searchInput: { flex: 1, background: "none", border: "none", outline: "none", fontSize: 14, fontFamily: "inherit", color: "#333" },
  navRight: { display: "flex", gap: 12, alignItems: "center" },
  btnDeposer: { background: "#E8553A", color: "white", border: "none", padding: "10px 20px", borderRadius: 10, cursor: "pointer", fontWeight: 700, fontSize: 14, boxShadow: "0 4px 12px rgba(232,85,58,0.25)" },
  ...
  btnLogin: { fontSize: 13, background: "#f5f5f3", border: "none", cursor: "pointer", padding: "8px 16px", borderRadius: 10, fontWeight: 600 },
  ...
  heroTitle: { fontSize: "clamp(2.2rem, 5vw, 3.5rem)", margin: "0 0 20px", fontWeight: 800, lineHeight: 1.15, letterSpacing: -1 },
  ...
  formContainer: { maxWidth: 600, margin: "50px auto", padding: "40px 35px", background: "white", borderRadius: 22, boxShadow: "0 10px 40px rgba(0,0,0,0.08)", border: "1px solid #f0f0f0" },
  ...
  input: { padding: "14px 16px", borderRadius: 12, border: "1px solid #e0e0e0", fontSize: 15, outline: 'none', fontFamily: "inherit", background: "#fafaf8" },
  btnPublish: { padding: "16px", background: "#E8553A", color: "white", border: "none", borderRadius: 12, fontWeight: 700, fontSize: 16, cursor: "pointer", marginTop: 8, boxShadow: "0 6px 20px rgba(232,85,58,0.3)" },
  footer: { background: "#111", color: "#fff", padding: "60px 24px 30px", marginTop: 60 },
  footerInner: { maxWidth: 1280, margin: "0 auto", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 40 },
